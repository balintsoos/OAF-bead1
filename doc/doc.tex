...
\begin{enumerate}[topsep=1pt,noitemsep,leftmargin=*]
	\item \textit{Elem berakása a halmazba}\\
	\item \textit{Elem kivétele a halmazból}\\
	\item \textit{Üres-e a halmaz}\\
	\item \textit{Elem benne van-e a halmazban}\\
	\item \textit{Halmaz kiírása}\\
	\item \textit{Két halmaz metszete}\\
\end{enumerate}
